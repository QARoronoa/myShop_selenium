...
def test_passage_commande(setup, formulaire_adresse):
    ...
    with allure.step("remplir le formulaire adresse"):
        address_page.remplir_le_formlaire(**formulaire_adresse)
        address_page.cliquer_sur_proceed_to_checkout()

    with allure.step("terms & conditions"):
        shipping_page.accepter_terms_conditions()
